...
### Core Logic (The "Why")
DHH students develop a "Survival Nod"—smiling and nodding even when they don't understand, to avoid social friction. The teacher must bypass this by checking *performance*, not *perception*.
